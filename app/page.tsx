    ...
    <div className="min-h-screen">
      ...
      <section className="py-24 bg-white border-t border-gray-200">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-12">
          ...
          >
            <div className="mb-4">
              <span className="font-[family-name:var(--font-playfair)] text-7xl md:text-8xl font-light text-[color:var(--color-brand-cyan)] lowercase">
                keyes
              </span>
            </div>
            <div className="text-[color:var(--color-brand-cyan)] text-base tracking-[0.3em] uppercase">
              REAL ESTATE
            </div>
          </motion.div>
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Link href="/#info2"><Button className="bg-black text-white hover:bg-gray-800 px-10 py-7 text-lg">Learn More</Button></Link>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-2xl">
          ...
          <motion.form
            ...
            onSubmit={async (e) => {
              ...
              const data = {
                ...
                multiAddress: formData.get('multiAddress'),
          ...
          >
            ...
            <div>
              <label className="block text-base text-[color:var(--color-text-dark)] mb-3">Multi-line address</label>
              <textarea
                name="multiAddress"
                rows={3}
                className="w-full border border-gray-300 rounded-md px-4 py-3 focus:outline-none focus:border-black resize-none text-base"
              />
            </div>
